...
# -------------------------------------------------------------------------------
# Name:         sfp_crossref
# Purpose:      NecroSpider plug-in for scanning links identified from the
...
class sfp_crossref(NecroSpiderPlugin):
    ...
    def handleEvent(self, event):
        ...
        if not matched:
            ...
            if eventName == "LINKED_URL_EXTERNAL" and self.opts['checkbase']:
                ...
                url = NecroSpiderHelpers.urlBaseUrl(eventData)
