...
# Purpose:      NecroSpider plug-in for attempting a DNS zone transfer.
#
...
class sfp_dnszonexfer(NecroSpiderPlugin):
                ...
                for row in ret:
                    ...
                    if len(grps) > 0:
                        for strdata in grps:
                            ...
                            evt = NecroSpiderEvent("INTERNET_NAME", strdata, self.__name__, parentEvent)
                            self.notifyListeners(evt)
