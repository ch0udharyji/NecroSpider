...
class sfp_pulsedive(NecroSpiderPlugin):
    ...
    def query(self, qry):
        ...
        res = self.sf.fetchUrl(url, timeout=30, useragent="NecroSpider")
    ...
    def handleEvent(self, event):
        ...
        for addr in qrylist:
            ...
            if attributes:
                ...
                if ports:
                    for p in ports:
                        e = NecroSpiderEvent('TCP_PORT_OPEN', addr + ':' + p, self.__name__, event)
