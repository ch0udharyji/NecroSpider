...
# Purpose:      NecroSpider plug-in for using the 'Nuclei' tool.
...
class sfp_tool_nuclei(NecroSpiderPlugin):
        ...
        try:
            for line in content.split("\n"):
                ...
                if host != eventData:
                    ...
                    srcevent = NecroSpiderEvent(srctype, host, self.__name__, event)
