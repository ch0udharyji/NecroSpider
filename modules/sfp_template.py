...
class sfp_template(NecroSpiderPlugin):
    ...
    meta = {
        ...
        'summary': "This is an example module to help developers create their own NecroSpider modules.",
    ...
    def setup(self, sfc, userOpts=dict()):
        ...
        # instead since on NecroSpider HX, different mechanisms are used to persist
        ...
        # utilised in NecroSpider HX and not the open source version.
    ...
    # For a list of all events, check necrospider/db.py.
    ...
    def query(self, qry):
        ...
        # from global config), and the user agent is NecroSpider so that the
        ...
        # - fatal(message) if it's a horrible thing and should kill NecroSpider completely
    ...
    def handleEvent(self, event):
        # The three most used fields in NecroSpiderEvent are:
        ...
        for addr in qrylist:
            ...
            if eventName == 'NETBLOCK_OWNER':
                ...
                # to process and is a fundamental part of the NecroSpider architecture.
                ...
                # event of this event. This enables NecroSpider to link events so users
            ...
            evt = NecroSpiderEvent("RAW_RIR_DATA", str(rec), self.__name__, pevent)
            ...
            os = rec.get('os')
            if os:
                evt = NecroSpiderEvent("OPERATING_SYSTEM", f"{os} ({addr})", self.__name__, pevent)
                self.notifyListeners(evt)
