...
# Purpose:      NecroSpider plug-in for retrieving company information from
#               OpenCorporates.
#
...
class sfp_opencorporates(NecroSpiderPlugin):
    ...
    def extractCompanyDetails(self, company, sevt):
        ...
        if location:
            if len(location) < 3 or len(location) > 100:
                ...
                e = NecroSpiderEvent("PHYSICAL_ADDRESS", location, self.__name__, sevt)
        ...
        if previous_names:
            for previous_name in previous_names:
                ...
                if p:
                    ...
                    e = NecroSpiderEvent("COMPANY_NAME", p, self.__name__, sevt)
                    self.notifyListeners(e)
        ...
        if officers:
            for officer in officers:
                ...
                if n:
                    ...
                    e = NecroSpiderEvent("RAW_RIR_DATA", "Possible full name: " + n, self.__name__, sevt)
                    self.notifyListeners(e)
