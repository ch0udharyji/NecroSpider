...
class sfp_junkfiles(NecroSpiderPlugin):
    ...
    def checkValidity(self, junkUrl):
        ...
        res = self.sf.fetchUrl(fetch, headOnly=True,
                               ...
                               verify=False)
        if res['code'] != "404":
            host = NecroSpiderHelpers.urlBaseUrl(junkUrl)
    ...
    def handleEvent(self, event):
        ...
        host = NecroSpiderHelpers.urlBaseUrl(eventData)
            ...
            if "." + ext + "?" in eventData or "." + ext + "#" in eventData or \
                ...
                for x in self.opts['fileexts']:
                    ...
                    if res['code'] == "200":
                        ...
                        evt = NecroSpiderEvent("JUNK_FILE", fetch, self.__name__, event)
                        self.notifyListeners(evt)

        base = NecroSpiderHelpers.urlBaseDir(eventData)
