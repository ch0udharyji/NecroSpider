...
# Purpose:      NecroSpider plug-in for identifying potential Google Object Storage
...
class sfp_googleobjectstorage(NecroSpiderPlugin):
    ...
    def handleEvent(self, event):
        ...
        for b in ret:
            ...
            if bucket[2] != "0":
                ...
                evt = NecroSpiderEvent("CLOUD_STORAGE_BUCKET_OPEN", bucketname + ": " + bucket[2] + " files found.",
                                      self.__name__, evt)
                self.notifyListeners(evt)
