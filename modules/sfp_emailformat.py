...
# Purpose:      NecroSpider plug-in for retrieving e-mail addresses
...
class sfp_emailformat(NecroSpiderPlugin):
    ...
    def handleEvent(self, event):
        ...
        emails = NecroSpiderHelpers.extractEmailsFromText(data)
        for email in emails:
