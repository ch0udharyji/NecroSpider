# -------------------------------------------------------------------------------
# Name:        sfp_callername
# Purpose:     NecroSpider plug-in to search CallerName.com for a phone number
...
class sfp_callername(NecroSpiderPlugin):
    ...
    def handleEvent(self, event):
        ...
        if rep_good_match and rep_bad_match:
            ...
            if bad_votes > good_votes:
                ...
                evt = NecroSpiderEvent('MALICIOUS_PHONE_NUMBER', text, self.__name__, event)
                self.notifyListeners(evt)
