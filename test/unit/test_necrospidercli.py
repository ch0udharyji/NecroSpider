# test_necrospidercli.py
import io
import pytest
import sys
import unittest

from sfcli import NecroSpiderCli


@pytest.mark.usefixtures
class TestNecroSpiderCli(unittest.TestCase):
    """
    Test TestNecroSpiderCli
    """
    ...
    def test_do_debug_should_toggle_debug(self):
        ...
        """
        sfcli = NecroSpiderCli(self.cli_default_options)
