...
class TestNecroSpiderWebUi(unittest.TestCase):
    """
    Test NecroSpiderWebUi
    """
    ...
    def test_init_no_web_config_should_raise(self):
        ...
        """
        with self.assertRaises(TypeError):
            NecroSpiderWebUi(self.web_default_options, None)

        with self.assertRaises(ValueError):
            NecroSpiderWebUi(self.web_default_options, dict())
    ...
    def test_init(self):
        ...
        sfwebui = NecroSpiderWebUi(self.web_default_options, opts)
        self.assertIsInstance(sfwebui, NecroSpiderWebUi)
    ...
    def test_scan_export_logs_invalid_scan_id_should_return_string(self):
        """
        Test scanexportlogs(self: 'NecroSpiderWebUi', id: str, dialect: str = "excel") -> str
        """
        opts = self.default_options
        opts['__modules__'] = dict()
        sfwebui = NecroSpiderWebUi(self.web_default_options, opts)
    ...
    def test_start_scan_should_start_a_scan(self):
        ...
        opts['__modules__'] = dict()
        sfwebui = NecroSpiderWebUi(self.web_default_options, opts)
        start_scan = sfwebui.startscan('example scan name', 'necrospider.net', 'example module list', None, None)
    ...
    def test_start_scan_unrecognized_scantarget_type_should_return_error(self):
        ...
        self.assertIn('Invalid target type. Could not recognize it as a target NecroSpider supports.', start_scan)
    ...
    def test_start_scan_invalid_modules_should_return_error(self):
        ...
        opts['__modules__'] = dict()
        sfwebui = NecroSpiderWebUi(self.web_default_options, opts)
        start_scan = sfwebui.startscan('example scan name', 'necrospider.net', None, None, None)
        self.assertIn('Invalid request: no modules specified for scan.', start_scan)
        start_scan = sfwebui.startscan('example scan name', 'necrospider.net', '', '', '')
        self.assertIn('Invalid request: no modules specified for scan.', start_scan)
    ...
    def test_start_scan_invalid_typelist_should_return_error(self):
        ...
        opts['__modules__'] = dict()
        sfwebui = NecroSpiderWebUi(self.web_default_options, opts)
        start_scan = sfwebui.startscan('example scan name', 'necrospider.net', None, 'invalid type list', None)
        self.assertIn('Invalid request: no modules specified for scan.', start_scan)
        start_scan = sfwebui.startscan('example scan name', 'necrospider.net', '', 'invalid type list', '')
        self.assertIn('Invalid request: no modules specified for scan.', start_scan)
