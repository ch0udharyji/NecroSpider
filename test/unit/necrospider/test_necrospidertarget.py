# test_necrospidertarget.py
import unittest

from necrospider import NecroSpiderTarget


class TestNecroSpiderTarget(unittest.TestCase):
        ...
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
                    NecroSpiderTarget(invalid_type, target_type)
    ...
    def test_init_argument_targetType_invalid_type_should_raise_TypeError(self):
        ...
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
                    NecroSpiderTarget(target_value, invalid_type)

    def test_init_argument_targetType_invalid_should_raise_ValueError(self):
        target_value = 'example target value'
        with self.assertRaises(ValueError):
            NecroSpiderTarget(target_value, 'invalid target type')
    ...
    def test_init_supported_target_types(self):
        ...
        for target_type in self.valid_target_types:
            with self.subTest(target_type=target_type):
                ...
                self.assertIsInstance(target, NecroSpiderTarget)
