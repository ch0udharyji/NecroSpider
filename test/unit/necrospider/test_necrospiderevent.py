# test_necrospiderevent.py
import unittest

from necrospider import NecroSpiderEvent


class TestNecroSpiderEvent(unittest.TestCase):
    ...
    def test_init_root_event_should_create_event(self):
        ...
        event_type = 'ROOT'
        evt = NecroSpiderEvent(event_type, event_data, module, source_event)
        self.assertIsInstance(evt, NecroSpiderEvent)
    ...
    def test_init_nonroot_event_with_root_sourceEvent_should_create_event(self):
        ...
        module = ''
        source_event = ''
        source_event = NecroSpiderEvent(event_type, event_data, module, source_event)
        ...
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
                    NecroSpiderEvent(invalid_type, event_data, module, source_event)
    ...
    def test_init_argument_eventType_with_empty_value_should_raise_ValueError(self):
        ...
        with self.assertRaises(ValueError):
            NecroSpiderEvent(event_type, event_data, module, source_event)
    ...
    def test_init_argument_data_of_invalid_type_should_raise_TypeError(self):
        ...
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
                    NecroSpiderEvent(event_type, invalid_type, module, source_event)
    ...
    def test_init_argument_module_of_invalid_type_should_raise_TypeError(self):
        ...
        event_data = 'example event data'
        module = ''
        source_event = NecroSpiderEvent(event_type, event_data, module, "ROOT")
        ...
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
                    NecroSpiderEvent(event_type, event_data, invalid_type, source_event)
    ...
    def test_init_argument_sourceEvent_of_invalid_type_should_raise_TypeError(self):
        ...
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
                    NecroSpiderEvent(event_type, event_data, module, invalid_type)
