# test_necrospiderdb.py
import pytest
import unittest

from necrospider import NecroSpiderDb, NecroSpiderEvent


@pytest.mark.usefixtures
class TestNecroSpiderDb(unittest.TestCase):
    """
    Test NecroSpiderDb
    """
    ...
    def test_init_should_create_NecroSpiderDb_object(self):
        """
        Test __init__(self, opts, init=False)
        """
        sfdb = NecroSpiderDb(self.default_options, False)
        self.assertIsInstance(sfdb, NecroSpiderDb)
    ...
    def test_scanEventStore_should_store_a_scan_event(self):
        ...
        module = ''
        source_event = ''
        event = NecroSpiderEvent(event_type, event_data, module, source_event)
        instance_id = "example instance id"
