...
class NecroSpiderEvent():
    """NecroSpiderEvent object representing identified data and associated meta data.
    ...
    Attributes:
        ...
        sourceEvent (NecroSpiderEvent): NecroSpiderEvent that triggered this event
        sourceEventHash (str): Hash of the NecroSpiderEvent event that triggered this event
    ...
    def __init__(self, eventType: str, data: str, module: str, sourceEvent: 'NecroSpiderEvent') -> None:
        """Initialize NecroSpider event object.

        Args:
            eventType (str): Event type, e.g. URL_FORM, RAW_DATA, etc.
            data (str): Event data, e.g. a URL, port number, webpage content, etc.
            module (str): Module from which the event originated
            sourceEvent (NecroSpiderEvent): NecroSpiderEvent event that triggered this event
        """
    ...
    @property
    def sourceEvent(self) -> 'NecroSpiderEvent':
    ...
    @sourceEvent.setter
    def sourceEvent(self, sourceEvent: 'NecroSpiderEvent') -> None:
        """Source event which lead to this event.

        Args:
            sourceEvent (NecroSpiderEvent): source event
        ...
        if not isinstance(sourceEvent, NecroSpiderEvent):
            raise TypeError(f"sourceEvent is {type(sourceEvent)}; expected NecroSpiderEvent()")
